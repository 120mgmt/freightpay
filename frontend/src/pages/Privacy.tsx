  ...
  <div className="min-h-screen bg-background text-foreground">
    ...
    <main className="max-w-3xl mx-auto px-6 py-16">
      ...
      <Section title="1. Information We Collect">
        <p><strong className="text-foreground">Account data:</strong> Name, email, company name, and password (hashed — never stored in plain text).</p>
        <p><strong className="text-foreground">Business data:</strong> Driver information, payroll records, settlement amounts, and financial data you enter into the Service.</p>
        <p><strong className="text-foreground">Usage data:</strong> Log files, IP addresses, browser type, pages visited, and timestamps — used to operate and improve the Service.</p>
        <p><strong className="text-foreground">Payment data:</strong> Billing is handled by Stripe. We receive only a tokenized reference; full card numbers are never transmitted to or stored by LedgerHaul.</p>
      </Section>
      ...
      <Section title="6. Your Rights">
        <p>Depending on your jurisdiction, you may have the right to access, correct, or delete your personal data. To exercise these rights, email <a href="mailto:privacy@ledgerhaul.com" className="underline hover:text-foreground">privacy@ledgerhaul.com</a>. We will respond within 30 days.</p>
      </Section>
      ...
      <Section title="9. Contact">
        <p>Privacy questions: <a href="mailto:privacy@ledgerhaul.com" className="underline hover:text-foreground">privacy@ledgerhaul.com</a></p>
      </Section>
    </main>
